...
const sampleTracks: Track[] = [
  {
    ...
    duration: 158,
    cover: 'https://upload.wikimedia.org/wikipedia/en/9/9f/Sunflower_Post_Malone.png',
  ...
  },
  {
    ...
    album: 'Fine Line',
    duration: 174,
    cover: 'https://upload.wikimedia.org/wikipedia/en/0/03/Harry_Styles_-_Watermelon_Sugar.png',
